...
- [Запись IQ сигнала с приемника Малахит DSP3](#запись-iq-сигнала-с-приемника-малахит-dsp3)
  - [Способы](#способы)
  - [0. Общее. Определить устройство для захвата IQ сигнала с приемника Малахит](#0-общее-определить-устройство-для-захвата-iq-сигнала-с-приемника-малахит)
...
### Способы
  ...
  1. Запись с помощью [GRC (GNU Radio)](https://www.gnuradio.org/)
  1. Запись с помощью SDR программ 

### 0. Общее. Определить устройство для захвата IQ сигнала с приемника Малахит
